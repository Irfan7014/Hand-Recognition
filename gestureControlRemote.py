...
wasdGamesphoto = PhotoImage(file=r"./wasdKeys.png")
powerpointphoto=PhotoImage(file=r"./powerpoint.png")
vlcmediaphoto=PhotoImage(file=r"./vlcmedia.png")
keymappingphoto=PhotoImage(file=r"./keymapping.png")
teamname=PhotoImage(file=r"./TeamLabel.png")
